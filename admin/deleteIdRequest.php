...
?>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">DELETE REQUESTED ID</h5>
            ...
            <?php
                ...
                if($run->num_rows>0){
                    ...
                    ?>
                        ...
                        <form method="POST" action="deleteIdRequest-process.php">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-info"> <a href="idrequest.php" class="btn btn-info">Cancel</a> </button>
